...
This project creates almost all the outputs needed for the web app at https://ideaapps.cerge-ei.cz/zamestnancistatu/. 

- The build pipeline is in build.R
- It is meant to be run every year when another year of data is added. The guide for what needs to be done is in [](howto-update-nextyear.md)
- There is also README.md

It is written in a mix of base R and tidyverse style. Any new code should be writte in tidyverse.
